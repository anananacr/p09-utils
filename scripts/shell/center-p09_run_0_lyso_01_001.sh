...
python3 genetic.py -i /gpfs/cfel/user/rodria/proc/p09_test/moving_beam/lyso_01_001_100/../lists/lyso_01_001.lst -a /gpfs/cfel/user/rodria/proc/p09_test/moving_beam/lyso_01_001_100/gen_images_refs.h5 -p r -o /gpfs/cfel/user/rodria/proc/p09_test/moving_beam/lyso_01_001_200/run_0/gen_images.h5 -g 60 -r 0.95 -t 1 -l 0.616
