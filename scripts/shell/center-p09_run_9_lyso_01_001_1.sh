...
python3 genetic.py -i /gpfs/cfel/user/rodria/proc/p09_test/moving_beam/lyso_01_001_1/run_9/gen_images.h5 -a /gpfs/cfel/user/rodria/proc/p09_test/moving_beam/lyso_01_001_1/gen_images_refs.h5 -p g -g 50 -r 0.65 -t 1 -l 0
