...
python3 genetic.py -i /gpfs/cfel/user/rodria/proc/p09_test/moving_beam/lyso_01_001_4/run_0/gen_images.h5 -a /gpfs/cfel/user/rodria/proc/p09_test/moving_beam/lyso_01_001_4/gen_images_refs.h5 -p l -g 30 -r 0.95 -t 1 -l 0.610
